...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        """
        parser.add_argument('--dataroot', required=False, default='./datasets' , help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--model', type=str, default='pce', help='chooses which model to use. bicycle,, ...')
        ...
        parser.add_argument('--single_test', action='store_true', help='')
